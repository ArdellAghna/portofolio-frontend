...
const portfolioData = {
  hero: {
    title: "Hi, I'm Ardell Aghna Mahendra",
    titleIcon: (
    ...
    socialMedia: [
      {
        platform: "GitHub",
        icon: "bx bxl-github",
        href: "https://github.com/ArdellAghna",
      },
      {
        platform: "LinkedIn",
        icon: "bx bxl-linkedin",
        href: "https://www.linkedin.com/in/ardell-aghna-mahendra-293744286",
      },
      {
        platform: "Instagram",
        icon: "bx bxl-instagram",
        href: "https://www.instagram.com/ardellaghna/",
      },
      {
        platform: "Email",
        icon: "bx bx-envelope",
        href: "mailto:aghnaaardell@gmail.com",
      },
    ],
  },
  about: {
    ...
    biodata: [
      ...
      {
        label: "Email",
        value: "aghnaaardell@gmail.com",
        icon: "bx bx-user",
      },
    ],
    aboutNarrative: {
      whoAmI: {
        text: "I am a Computer Science student at ITB with a deep passion for solving complex problems through Data Analytics, Artificial Intelligence, and Software Engineering. My journey spans data storytelling, algorithm design, and full-stack development.",
        icon: "bx-info-circle",
      },
      approach: {
        text: "I believe meaningful impact comes from transforming raw data into actionable insights. From running A/B tests and building Tableau dashboards to designing algorithms and deploying AI-powered applications, I bring analytical depth and engineering precision to every challenge.",
        icon: "bx-bulb",
      },
    },
    experience: [
      {
        ...
        description:
          "Executed end-to-end data analysis workflows using Python (Pandas, NumPy) and SQL. Applied inferential statistics including A/B Testing and ANOVA. Built interactive BI dashboards using Tableau to monitor KPIs and identify market trends.",
      },
      {
      ...
      },
      {
        ...
        company: "Pakansuper Marketplace",
        period: "Aug 2023 – Dec 2023",
        description:
          "Developed a web-based marketplace for farmers and breeders, selected as the only project to represent ITB at the campus fair. Managed UI/UX design, domain, hosting, and all visual marketing assets.",
      },
    ],
    skills: [
      {
      ...
      },
      {
        ...
        svg: (
          <svg viewBox="0 0 100 100" fill="none">
            <path fill="#E97627" d="M47 20h6v60h-6z" />
            <path fill="#E97627" d="M20 47h60v6H20z" />
            <path fill="#5B9BD5" d="M30 35h6v30h-6z" opacity={0.8} />
            <path fill="#5B9BD5" d="M15 47h36v6H15z" opacity={0.8} />
            <path fill="#5B9BD5" d="M64 35h6v30h-6z" opacity={0.8} />
            <path fill="#5B9BD5" d="M49 47h36v6H49z" opacity={0.8} />
          </svg>
        ),
      },
      {
        ...
        svg: (
          <svg viewBox="0 0 100 100" fill="none">
            <rect x="10" y="35" width="25" height="30" rx="5" fill="#EA4B71" />
            <rect x="65" y="35" width="25" height="30" rx="5" fill="#EA4B71" />
            <path d="M35 50 Q50 30 65 50" stroke="#EA4B71" strokeWidth="5" fill="none" />
            <circle cx="50" cy="50" r="8" fill="#fff" stroke="#EA4B71" strokeWidth="3" />
          </svg>
        ),
      },
    ],
  ...
  projects: [
    {
      ...
      images: ["/ss-airline-analysis-project.png", "/ss-airline-analysis-project-2.png", "/ss-airline-analysis-project-3.png", "/ss-airline-analysis-project-4.png", "/ss-airline-analysis-project-5.png", "/ss-airline-analysis-project-6.png", "/ss-airline-analysis-project-7.png", "/ss-airline-analysis-project-8.png", "/ss-airline-analysis-project-9.png", "/ss-airline-analysis-project-10.png", "/ss-airline-analysis-project-11.png", "/ss-airline-analysis-project-12.png", "/ss-airline-analysis-project-13.png", "/ss-airline-analysis-project-14.png", "/ss-airline-analysis-project-15.png", "/ss-airline-analysis-project-16.png", "/ss-airline-analysis-project-17.png", "/ss-airline-analysis-project-18.png"],
      techStack: ["Python", "Pandas", "NumPy", "Tableau", "Matplotlib", "Seaborn"],
      description: "Analyzed a 30-year aviation dataset using Python to identify the impact of financial crises and post-pandemic shifts in passenger behavior. Designed a Tableau Story to visualize the transition of market dominance from business hubs to leisure destinations (Miami, Orlando).",
      features: ["Data Visualization", "Business Strategy"],
    },
    {
      title: "Buat_CV – ATS CV Search Application",
      link: "https://github.com/ArdellAghna/Tubes3_Buat_CV",
      images: ["/ss-buat-cv-project.png", "/ss-buat-cv-project-2.png", "/ss-buat-cv-project-3.png", "/ss-buat-cv-project-4.png", "/ss-buat-cv-project-5.png"],
      techStack: ["Python", "MySQL", "KMP", "Boyer-Moore", "Levenshtein", "Tkinter"],
      description: "An ATS-style CV search application that extracts and matches keywords from PDF resumes using structured string-matching algorithms (KMP, Boyer-Moore) to support exact search integrations, enhancing CV management and filtering efficiency.",
      features: ["String Matching Algorithms", "PDF Processing"],
    },
    {
      title: "TCP Chat Application",
      link: "https://github.com/ArdellAghna/tugas-besar-if2230-jaringan-komputer-dikom",
      images: ["/ss-chat-tcp-project.png", "/ss-chat-tcp-project-2.png", "/ss-chat-tcp-project-3.png"],
      techStack: ["C", "TCP/IP", "Socket Programming", "Networking"],
      description: "A robust client-server chat application built on the TCP protocol. It demonstrates core networking concepts by handling real-time message transmission, broadcasting, and concurrent multi-client connections seamlessly and securely.",
      features: ["Real-time Messaging", "Multi-client Support"],
    },
    {
      title: "Image Compression with Quadtree",
      link: "https://github.com/ArdellAghna/Tucil2_13523133_13523151",
      images: ["/ss-kizuna-project.png", "/ss-kizuna-project-2.png", "/ss-kizuna-project-3.png", "/ss-kizuna-project-4.png"],
      techStack: ["C++", "Quadtree", "Divide & Conquer"],
      description: "A quadtree-driven image compression system that applies divide-and-conquer segmentation to efficiently represent visual data, reinforcing foundations in spatial data structures, image processing logic, and performance-oriented algorithm design.",
      features: ["Quadtree Compression", "Spatial Data Structures"],
    },
    {
      title: "HalalHub",
      link: "https://github.com/ArdellAghna/IF2150-2024-K03-G07-HalalHub",
      images: ["/ss-halalhub-project.png"],
      ...
      features: ["GUI Application", "Business Management"],
    },
    {
      title: "IQ Puzzle Pro Solver",
      link: "https://github.com/ArdellAghna",
      images: ["/ss-iq-puzzle-project.png", "/ss-iq-puzzle-project-2.png", "/ss-iq-puzzle-project-3.png"],
      techStack: ["Python", "Backtracking", "Search Pruning"],
      description: "An algorithmic solver for the IQ Puzzle Pro game utilizing a brute-force approach optimized with intelligent search space pruning. It highlights strong problem-solving capabilities and an understanding of combinatorial optimization.",
      features: ["Brute Force Search", "Combinatorial Optimization"],
    },
    {
      title: "Skibiditify",
      link: "https://github.com/ArdellAghna/Tubes-Algeo02-23124",
      images: ["/ss-skibiditify-project.png"],
      techStack: ["Python", "Linear Algebra", "PCA", "NumPy"],
      description: "An application designed as an intelligent finder/recommender system, utilizing linear algebra and geometry concepts to process, search, and map complex user data requirements — featuring PCA-based image search and Query by Humming for audio.",
      features: ["PCA Image Search", "Audio Recognition"],
    },
    {
      title: "Jepangor – Full-Stack Web Application",
      link: "https://github.com/ArdellAghna/Tubes2_BE_Jepangor",
      images: ["/ss-jepangor-project.png"],
      techStack: ["Python", "FastAPI", "Next.js", "React", "TypeScript"],
      description: "A full-stack web application implementing a clean separation of concerns with independent backend API and frontend architectures. Designed to handle user management, structured routing, and robust data processing securely.",
      features: ["REST API", "Full-Stack Development"],
    },
    {
      title: "PurryMail",
      link: "https://github.com/ArdellAghna/Tubes-Alstrukdat",
      images: ["/ss-purrymail-project.png", "/ss-purrymail-project-2.png"],
...
export default function Portfolio() {
  ...
  const navigateProjectImage = (title: string, dir: "prev" | "next", total: number) => {
    setProjectImageIndices((prev) => {
      const cur = prev[title] ?? 0;
      const next = dir === "prev" ? (cur === 0 ? total - 1 : cur - 1) : (cur === total - 1 ? 0 : cur + 1);
              ...
              >
                ...
                <Button
                  onClick={() => {
                    ...
                    link.href = '/CV_Ardell_Aghna_Mahendra.pdf';
                    link.download = 'CV_Ardell_Aghna_Mahendra.pdf';
                    link.click();
                  }}
            ...
            >
              <div className="relative z-10">
                <ProfileImage
                  ...
                  alt="Ardell Aghna Mahendra Profile"
                  size="xl"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-16">
            ...
            <motion.div
              ...
              className="w-full"
            >
              <div className="grid grid-cols-2 grid-rows-[220px_220px] gap-3">
                {/* FOTO A - Left, spans 2 rows (fotosaya1) */}
                ...
                {/* FOTO B - Top Right (foto bersama teman) */}
                <div className="relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                  <img
                    src="/profile3.jpeg"
                    alt="Ardell dengan teman"
                    className="w-full h-full object-cover"
                  />
                </div>

                {/* FOTO C - Bottom Right (fotoketigasaya) */}
                <div className="relative overflow-hidden rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
                  <img
                    src="/profile6.jpg"
                    alt="Ardell Aghna Mahendra"
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto font-ubuntu">
                My journey through education, organizational roles, and work experience — building skills across data analytics, technology, and creative fields.
              </p>
            </div>
            <Timeline />
          </motion.div>
              ...
              <div className="mb-12 space-y-6">
                {portfolioData.projects.map((project, index) => (
                  ...
                  >
                    ...
                    <div className="relative w-full md:w-96 aspect-video bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden flex-shrink-0">
                      <img
                        src={project.images[projectImageIndices[project.title] ?? 0]}
                        alt={project.title}
                        className="w-full h-full object-cover object-left cursor-pointer transition-all duration-300"
                        onClick={() => openImageModal(project.images, projectImageIndices[project.title] ?? 0)}
                      />
                      {project.images.length > 1 && (
                        <>
                          <button
                            onClick={(e) => { e.stopPropagation(); navigateProjectImage(project.title, "prev", project.images.length); }}
                          ...
                          <button
                            onClick={(e) => { e.stopPropagation(); navigateProjectImage(project.title, "next", project.images.length); }}
                          ...
                          <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-1.5 z-10">
                            {project.images.map((_, i) => (
                              <button
                                key={i}
                                onClick={(e) => { e.stopPropagation(); setProjectImageIndices(prev => ({ ...prev, [project.title]: i })); }}
                                className={`w-2 h-2 rounded-full transition-all ${(projectImageIndices[project.title] ?? 0) === i ? "bg-white w-4" : "bg-white/50"}`}
                              />
                            ))}
                          </div>
                        </>
            ...
            {selectedImages.length > 1 && (
              <>
                <button
                  ...
                  className="absolute left-3 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-black/80 text-white rounded-full p-3 transition-colors"
                >
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
                </button>
                <button
                  onClick={(e) => { e.stopPropagation(); navigateModal("next"); }}
                  className="absolute right-3 top-1/2 -translate-y-1/2 bg-black/60 hover:bg-black/80 text-white rounded-full p-3 transition-colors"
                >
                ...
                <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 flex gap-2">
                  {selectedImages.map((_, i) => (
                    <button
                      ...
                      className={`rounded-full transition-all duration-200 ${i === selectedImageIndex ? "bg-white w-6 h-2.5" : "bg-white/40 w-2.5 h-2.5"}`}
                    />
                  ))}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex-1 grid grid-cols-3 gap-2">
              {["/jepretan/jepretan-3.jpeg", "/jepretan/jepretan-5.jpeg", "/jepretan/jepretan-7.jpeg", "/jepretan/jepretan-9.jpeg", "/jepretan/jepretan-11.jpeg", "/jepretan/jepretan-13.jpeg"].map((src, i) => (
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="inline-flex items-center gap-2 bg-white/10 text-white/70 text-sm font-medium px-4 py-2 rounded-full mb-6">
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-8">
                Beyond coding and data, I have a passion for visual documentation. These are moments I captured during breaks and holidays — reflecting my background in media and documentation at HMIF ITB.
              </p>
              <motion.a
                href="/photography"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center gap-3 px-8 py-4 bg-white text-gray-900 rounded-xl font-semibold hover:bg-gray-100 transition-all duration-300 shadow-lg"
              >
          ...
          >
            ...
            <div className="pt-8 border-t border-gray-200">
              <p className="text-sm text-gray-500" style={{ fontFamily: 'Ubuntu, "Ubuntu Fallback", sans-serif', fontWeight: 400 }}>
                © 2026 Ardell Aghna Mahendra. All rights reserved.
              </p>
            </div>
          </motion.div>
        </div>
